...
BLOCK_TERRAIN = False      # auf True setzen, um Hindernisse zu aktivieren

# Gebaeude als Rechtecke in Map-Pixeln: (x, y, breite, hoehe)
BUILDINGS = [
    (118, 100, 128, 108),   # Hauptbau mit Gruendach und Solaranlage
    (222,  48,  62,  52),   # Nordbau
    (196, 190, 100,  60),   # Mittelbau
    (226, 218,  80,  54),   # Weisser Flachbau
    (300, 196,  76,  54),   # Bau am Hof
    (286, 250,  78,  64),   # Werkstattbau
    (330, 314,  96,  62),   # Bau Suedost
    (416, 356, 104,  92),   # Langbau Suedost
    ( 62, 296,  92,  70),   # Bau Suedwest
    (174, 366,  90,  76),   # Bau Sued
]
